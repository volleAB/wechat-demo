...
onLoad: function(options) {  
  ...
  onHide: function() {
      ...
      success: function( res ) {  
        ...
        var content = "<div style=\"margin:10px; line-height:25px; font-weight:200; font-size:17px; color:black; word-break:normal\">" + res.data.content.replace(reg,"<br />\r").replace(/\\/g,"").replace("    "," ").replace("    "," ").replace("    "," ")+ "</div>";  
