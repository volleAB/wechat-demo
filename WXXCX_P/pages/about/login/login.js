...
Page({
  data: {
    ...
    passwd: '',
    angle: 0,
    loading: app.BASE_IMGURL + "/img/login/loading.gif",
    title: app.BASE_IMGURL +"/img/login/title.png",
    close: app.BASE_IMGURL +"/img/login/关闭.png",
    logo: app.BASE_IMGURL + "/img/login/logo.jpg",
    wave: app.BASE_IMGURL + "/img/login/wave.png",
    help: app.BASE_IMGURL + "/img/login/help.png",
    close: app.BASE_IMGURL + "/img/login/关闭.png",
  },
  onReady: function(){
    var _this = this;
